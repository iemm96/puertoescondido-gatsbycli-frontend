...
import {
  ModalSuccess,
  useModalSuccess,
} from "../components/common/ModalSuccess"
    ...
    <>
      ...
      <Layout persistentHeader={true}>
        ...
        <Container maxWidth="lg">
            ...
            <Grid container spacing={2}>
              ...
              >
                <Stack direction="column">
                  <Typography variant="subtitle1">Escríbenos</Typography>
                  ...
                  <Grid container mt={5}>
                    <Grid xs={12} md={6} item>
                      <Typography>Nuestras Redes Sociales:</Typography>
                    </Grid>
                    <Grid xs={12} md={6} item>
                      <SocialNetworksIcons />
                    </Grid>
          ...
          >
            <Grid item>
              <Button startIcon={<ChevronLeft />}>Volver al inicio</Button>
            </Grid>
          </Grid>
        </Container>
      </Layout>

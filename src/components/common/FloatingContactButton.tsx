...
const FloatingContactButton = () => {
  ...
  return (
    <StyledBotonFlotante
      bottom={bottom}
      className={open ? "open" : "" + (shake && " shake alert")}
      onClick={() => {
        if (open === false) {
          setOpen(true)
        }
        ...
        <>
          ...
          >
            ...
            <Button
              variant="outlined"
              fullWidth
              startIcon={<Email sx={{ color: "white", fontSize: 20 }} />}
              onClick={() =>
                handleClick(
                  `mailto:inmobiliariapuertoescondido@gmail.com&subject=Hola+los+contacto+desde+su+pagina+web`
                )
              }
            >
              Email
            ...
            <Button
              variant="outlined"
              fullWidth
              startIcon={<Messenger size={20} color={"white"} />}
              onClick={() =>
                handleClick("https://m.me/TerrenosenPuertoEscondido")
              }
            >
              Messenger
            </Button>
            <Button
              variant="outlined"
              fullWidth
              startIcon={<PhoneCall size={20} color={"white"} />}

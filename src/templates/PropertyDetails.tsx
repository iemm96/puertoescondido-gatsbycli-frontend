                ...
                >
                  ...
                  >
                    ...
                    {data?.price && (
                      ...
                      >
                        $ {price && new Intl.NumberFormat().format(price)} mxn{" "}
                        {width &&
                          length &&
                          `· ${calculateArea(
                            parseInt(width),
                    ...
                    {location && (
                      <a
                        ...
                        target={
                          location?.lat && location?.lng ? "_blank" : "_self"
                        }
                      >
                    ...
                    <Stack sx={{ mt: 2 }} spacing={2} direction="row">
                      {bluePrintFile && (
                        <StyledButton
                          ...
                          variant="outlined"
                          onClick={() =>
                            window.open(bluePrintFile.url, "_blank")
                          }
                        >
                          Plano
                        </StyledButton>
                      ...
                      {brochureFile && (
                        <StyledButton
                          ...
                          variant="outlined"
                          onClick={() =>
                            window.open(brochureFile.url, "_blank")
                          }
                        >
                          Folleto
                        </StyledButton>
                  ...
                  <StyledButton
                    ...
                    onClick={() =>
                      window.open(
                        `https://api.whatsapp.com/send/?phone=522226623751&text=Hola+visité+su+sitio+web+y+me+interesa+más+información+sobre+${name.replace(
                          " ",
                          "+"
                        )}`
                      )
